...
/**
 * A timer which will post the associated [events] when [remainingTicks] ticks have elapsed.
 *
 * @property remainingTicks the number of ticks that need to pass until the timer expires
