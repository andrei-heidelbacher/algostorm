 ...
 * [Collision] events.
 *
 * Upon receiving a [TranslateIntent] event, it the [Box] of the entity is
 * translated by the indicated amount. If the moved entity is [Rigid] and there
 * are any other `Rigid` entities with their boxes overlapping the destination
 * location, the entity is restored to it's initial location and a [Collision]
 * event is triggered with every overlapping entity, having this entity as the
 * source and each other entity as the target.
 *
